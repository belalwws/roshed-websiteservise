...
import { Star, MessageCircle, Quote, X, ChevronLeft, ChevronRight, ZoomIn, ShieldCheck } from 'lucide-react';
  ...
  return (
    <section className="reviews-section" id="reviews">
      <div className="container">
            ...
            >
              ...
              <div style={{ position: 'relative', height: '210px', overflow: 'hidden', background: '#07162c' }}>
                <img 
                  ...
                  alt={`Student review from ${item.country}`}
                  style={{
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
        ...
        {/* Interactive Lightbox Modal (Fully Responsive) */}
        {selectedImage && (
          <div 
            style={{
              position: 'fixed',
          ...
          >
            ...
            >
              ...
              <div style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px', padding: '0 4px' }}>
                <div style={{ textAlign: 'left' }}>
                  <div style={{ fontSize: '14.5px', fontWeight: 800, color: 'var(--gold-300)' }}>
                    {selectedImage.student}
                  </div>
                  <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.7)' }}>
                    {selectedImage.category} • WhatsApp Verified
                  </div>
                </div>
              ...
              >
                <img 
                  ...
                  alt={`Authentic testimonial from ${selectedImage.student}`}
                  style={{
                    maxHeight: '62vh',
                    maxWidth: '100%',
                    objectFit: 'contain'
              ...
              <div style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '14px', padding: '0 4px' }}>
                <button
                  onClick={handlePrev}
                  className="button button-secondary"
                  style={{ minHeight: '36px', padding: '0 14px', fontSize: '12.5px', gap: '6px' }}
                >
                  <ChevronLeft size={16} />
                  <span>Previous</span>
                </button>
                ...
                <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.65)' }}>
                  {lightboxIndex + 1} of {filteredReviews.length}
                </span>
